...
let ProductsController = class ProductsController {
    ...
    async addMovement(req, id, payload) {
    ...
    async getSerials(req, id, status) {
        const tenantId = req.headers['x-tenant-id'];
        if (!tenantId)
            throw new common_1.UnauthorizedException('TenantID missing');
...
], ProductsController.prototype, "addMovement", null);
__decorate([
    (0, common_1.Get)(':id/serials'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], ProductsController.prototype, "getSerials", null);

...
let InternalController = class InternalController {
    ...
    async syncTenant(apiKey, body) {
        if (apiKey !== 'FACTURAPRO_MASTER_KEY_2026') {
            throw new common_1.UnauthorizedException('Clave de API inválida.');
        }
...
__decorate([
    (0, common_1.Post)('sync-tenant'),
    __param(0, (0, common_1.Headers)('x-api-key')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], InternalController.prototype, "syncTenant", null);
